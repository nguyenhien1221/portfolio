const socialLinks = [
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 19 19" fill="currentColor" aria-hidden>
        <path
          fillRule="evenodd"
          clipRule="evenodd"
    ...
    <nav className="flex flex-wrap items-center gap-6" aria-label="Social links">
      {socialLinks.map(({ label, href, icon }) => (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2 font-mono text-xs tracking-[0.15em] text-muted transition-colors hover:text-accent"
        >
          {icon}
          {label}
        </a>
